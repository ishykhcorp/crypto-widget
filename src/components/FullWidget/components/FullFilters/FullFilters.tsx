...
const FullFilters = ({ symbolConfig, intervalConfig }: TFullFiltersProps) => (
    ...
    <Grid size={2}>
      <FormControl fullWidth>
        ...
        <Select
          ...
          id="kline-interval"
        >
          {Object.keys(klineIntervalValueLabelMap).map((intervalValue) => (
...
export default memo(FullFilters);
